...
int main()
{
    ...
    gpio_set_function(SSD1306_SDA_PIN, GPIO_FUNC_I2C);  //Use DISP_SDA_PIN as I2C
    gpio_set_function(SSD1306_SCL_PIN, GPIO_FUNC_I2C);  //Use DISP_SCL_PIN as I2C
    ...
    oled = new GFX(SSD1306_I2C_ADDR, size::W128xH64, i2c0);         //Declare oled instance
    ...
    while (1)
    {
        ...
        sleep_ms(2000);
        oled->stop_scroll();
        oled->vertical_horizontal_scroll(true, 0x00, 0x07, SSD1306_SCROLLSPEED_2, 1);
        sleep_ms(2000);
        oled->stop_scroll();
